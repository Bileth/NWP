...
if($files["name"] != '') {
  ...
  $fullPath = $_REQUEST["path"].$files["name"]; 
     ...
     $encryptedImage = openssl_encrypt($imageString, $cipher, $key, 0, $iv); //funckija za enkripciju
      ...
      $myfile = fopen("./encoded/"."$fullPath.aes256", "w") or die("Unable to open file!"); // stvaranje novog filea s ekstenzijom .aes256 u koju se zapisuje kriptirani i base64 kodirani string
