<?php
 ...
 $key="veryweakkey";
 $iv='initVector123456';
 $Path = $_SERVER['DOCUMENT_ROOT'] ."/zad2/encoded/";//lokacija enkriptiranih slika

 $decodedPath = $_SERVER['DOCUMENT_ROOT'] ."/zad2/decoded/";// lokacija u koju se spremaju dekodirane slike
